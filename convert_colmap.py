...
def main(exp_dir, image_dir, pcd_file=None, no_scale=False, pred_w=None, pred_h=None, verbose=False):
    """Convert VGGT-Align output to COLMAP format.

    Args:
        exp_dir: VGGT-Align experiment output directory
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Convert VGGT-Align output to COLMAP format')
    parser.add_argument('--exp_dir', required=True, help='VGGT-Align experiment output directory')
